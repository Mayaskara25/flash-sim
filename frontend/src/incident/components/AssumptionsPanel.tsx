...
export function AssumptionsPanel() {
  ...
  return <>
    <button type="button" onClick={() => setOpen(true)} className="border border-white/35 px-1.5 py-0.5 text-[10px] tracking-wide underline">SIMULATION · ASSUMPTIONS</button>
