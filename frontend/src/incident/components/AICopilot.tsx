...
export function AICopilot({ onAsk }: { onAsk: (question: string) => Promise<CopilotReply> }) {
  ...
  const startVoice = () => {
    ...
    if (!Constructor) { setError('Voice input is unavailable in this browser. You can still type a P2 question.'); return }
